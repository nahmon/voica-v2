      ...
      <section style={{ background: darkBg, padding: isMobile ? "60px 20px" : "80px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={{ fontSize: isMobile ? 24 : 36, fontWeight: 700, color: "#fff", margin: "0 0 10px", fontFamily: F, letterSpacing: "-0.03em" }}>
              {title(C.purpleLight)}
            </h2>
    ...
    <section style={{ padding: isMobile ? "60px 20px" : "80px 24px", background: "#fff" }}>
      <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
        <div style={{ marginBottom: 36 }}>
          ...
          <h2 style={{ fontSize: isMobile ? 28 : 36, fontWeight: 700, color: C.navy, margin: "0 auto 10px", fontFamily: F, letterSpacing: "-0.03em" }}>{title}</h2>
          ...
          <div style={{ width: isMobile ? "100%" : "100%", minWidth: 0 }}>
            ...
            <h1 style={{
              ...
              <span style={{ color: C.navy, display: "block" }}>
                {lang === "ko" ? "비싸고 오래 걸리는" : "Slow, expensive research?"}
              </span>
              <span style={{ color: C.navy, display: "block" }}>
                {lang === "ko" ? "사용자 조사," : "Interview hundreds with AI"}
              </span>
              <span style={{ display: "block", background: `linear-gradient(135deg, ${C.purple}, #3d2ab0)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                {lang === "ko" ? "AI로 수백 명을 한 번에" : "powered by AI"}
              </span>
            </h1>
