...
export default function AdvertiserLoginScreen({ go }) {
  ...
  const handleNaverLogin = () => {
    ...
    window.location.href = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=${clientId}&redirect_uri=${encodeURIComponent(window.location.origin + '/auth/naver/callback')}&state=${randomState}`;
  };
