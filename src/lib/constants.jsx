...
export const Ic = {
  ...
  Bot:          (p={}) => <svg width={p.s||24} height={p.s||24} viewBox="0 0 24 24" fill="none"><rect x="3" y="8" width="18" height="13" rx="3" fill={p.c2||"#a5b4fc"}/><circle cx="9" cy="13.5" r="2.5" fill={p.c||"#4f46e5"}/><circle cx="15" cy="13.5" r="2.5" fill={p.c||"#4f46e5"}/><rect x="9.5" y="17.5" width="5" height="2" rx="1" fill={p.c||"#4f46e5"}/><rect x="10.5" y="5.5" width="3" height="2.5" rx="1" fill={p.c2||"#a5b4fc"}/><circle cx="12" cy="4.5" r="2" fill={p.c||"#4f46e5"}/><rect x="0.5" y="12" width="2.5" height="5" rx="1.25" fill={p.c2||"#a5b4fc"}/><rect x="21" y="12" width="2.5" height="5" rx="1.25" fill={p.c2||"#a5b4fc"}/></svg>,
