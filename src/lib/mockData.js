...
export const FAQ_DATA = [
  {
    ...
    items: [
      {
        q: "Voice Survey는 어떤 서비스인가요?",
        a: "Voice Survey는 AI가 인터뷰어 역할을 맡아 수백 명의 패널과 동시에 음성·텍스트 인터뷰를 진행하고, 결과를 자동으로 분석·요약해 드리는 사용자 리서치 플랫폼입니다."
      },
      {
      ...
      },
      {
        ...
        a: "요금제에 따라 다르며, Pro 플랜 기준 회당 최대 300명, 엔터프라이즈 플랜은 제한 없이 동시 인터뷰를 진행할 수 있습니다."
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "무료로 사용해볼 수 있나요?",
        a: "네, 무료 플랜에서 월 3회까지 인터뷰를 진행할 수 있습니다. 회당 최대 10명 응답, 기본 AI 리포트가 제공됩니다."
      },
      {
        q: "요금제는 어떻게 구성되어 있나요?",
        a: "무료, Pro(월 99,000원), Enterprise(별도 문의) 세 가지 플랜이 있습니다. Pro 플랜은 연간 결제 시 20% 할인됩니다. 요금제 페이지에서 상세 비교가 가능합니다."
      },
      {
        q: "결제 수단은 무엇을 지원하나요?",
