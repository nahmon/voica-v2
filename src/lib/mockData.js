...
export const REPORT_THEMES = [
  { label: "Feature Utility", count: 14, pct: 37, sentiment: "positive", color: C.purple, bg: C.purpleBg, border: "rgba(110,75,255,0.18)", icon: "✦" },
...
export const FAQ_DATA_KO = [
  {
    category: "서비스 이용",
    items: [
      { q: "보이스서베이란 무엇인가요?", a: "보이스서베이는 AI가 인터뷰어 역할을 맡아 수백 명의 인터뷰 패널에게 동시에 음성 및 텍스트 인터뷰를 진행하고, 결과를 자동으로 분석·요약하는 사용자 조사 플랫폼입니다." },
      { q: "인터뷰는 어떻게 진행되나요?", a: "연구자가 질문 시나리오를 설정하면, AI가 인터뷰 패널에게 음성 또는 텍스트로 질문을 전달합니다. 응답은 실시간으로 수집되고, 인터뷰가 끝나면 AI가 핵심 인사이트와 통계가 담긴 리포트를 생성합니다." },
      { q: "몇 명을 동시에 인터뷰할 수 있나요?", a: "플랜에 따라 달라요. Pro 플랜은 세션당 최대 300명, Enterprise 플랜은 제한 없이 동시 인터뷰할 수 있어요." },
      { q: "인터뷰 결과 리포트는 언제 받을 수 있나요?", a: "마지막 인터뷰 패널이 응답을 완료한 후 보통 5~10분 내에 AI 분석 리포트가 만들어져요. 대시보드에서 확인하거나 PDF로 내보낼 수 있어요." },
    ]
  },
  {
    category: "결제 / 요금",
  ...
  },
  {
    category: "패널 참여 / 보상",
    items: [
      { q: "인터뷰 패널로 어떻게 참여할 수 있나요?", a: "인터뷰 패널 메뉴에서 회원가입 후, 인터뷰 보드를 탐색해 원하는 인터뷰를 신청하면 돼요. 특별한 자격 요건 없이 누구나 지원할 수 있어요." },
